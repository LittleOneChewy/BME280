...
/*****************************************************************/
   ...
   enum CalcMethodFloat
   {
      CalcMethodFloat_False = 0,
      CalcMethodFloat_True = 1
   };
...
/*****************************************************************/
   ...
   struct Settings
   {
      Settings(
         ...
         CalcMethodFloat _cm = CalcMethodFloat_False,
         float _temp_offset = 0.0
      ): tempOSR(_tosr),
         humOSR(_hosr),
         presOSR(_posr),
         mode(_mode),
